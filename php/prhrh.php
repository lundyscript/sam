...
if(isset ($_POST['cari'])){
  ...
  <table class="table">
    <tr>
      <td width="20%"></td>
      <td width="60%" align="center"><b><?php echo $_POST['txttgl1']; ?></b></td>
      <td width="20%"></td>
    </tr>
  </table>
  ...
  <tbody>
  <?php
  $query = mysql_query("SELECT idh, tipe, SUM(jumlah) AS jumlah, SUM(total) AS total FROM penjualan WHERE tglorder='$txttgl1' GROUP BY tipe ORDER BY tipe DESC") or die ('Error!!'.mysql_error());
  $arrayjmlh = array();
